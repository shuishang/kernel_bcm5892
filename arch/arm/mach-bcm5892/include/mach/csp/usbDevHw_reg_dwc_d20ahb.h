...
#define usbDevHw_REG_ENDPT_CFG_PKT_MAX_MASK                 (0x3ff << usbDevHw_REG_ENDPT_CFG_PKT_MAX_SHIFT)
...
#define usbDevHw_REG_ENDPT_CFG_TYPE_MASK                    (0xf << usbDevHw_REG_ENDPT_CFG_TYPE_SHIFT)
