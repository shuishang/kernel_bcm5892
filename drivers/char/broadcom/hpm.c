...
#include <mach/csp/hpmHw_reg.h>

#ifndef CONFIG_ARCH_BCMRING
...
static int proc_dointvec_wxb(ctl_table *table, int write,
           void __user *buffer, size_t *lenp, loff_t *ppos );
static int proc_dostring_custom(ctl_table *table, int write,
			 void __user *buffer, size_t *lenp, loff_t *ppos);
static int proc_dointvec_dump(ctl_table *table, int write,
           void __user *buffer, size_t *lenp, loff_t *ppos );
static int proc_dointvec_tables(ctl_table *table, int write,
           void __user *buffer, size_t *lenp, loff_t *ppos );
static int proc_dointvec_cfg(ctl_table *table, int write,
           void __user *buffer, size_t *lenp, loff_t *ppos );
static int proc_dointvec_qos_enmask(ctl_table *table, int write,
           void __user *buffer, size_t *lenp, loff_t *ppos );
static int proc_dointvec_qos_tidemark(ctl_table *table, int write,
           void __user *buffer, size_t *lenp, loff_t *ppos );
#else
...
#endif
{
   ...
   {
#if LINUX_VERSION_CODE > KERNEL_VERSION(2,6,31)
      rc = proc_dostring(table, write, buffer, lenp, ppos ); /* No special processing for read. */
#else
