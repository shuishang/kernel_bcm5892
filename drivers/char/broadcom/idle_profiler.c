...
static int proc_do_hosticp_intvec_clear(ctl_table *table, int write,
           void __user *buffer, size_t *lenp, loff_t *ppos );

static int proc_do_hosticp_loadtest_intvec_enable(ctl_table *table, int write,
           void __user *buffer, size_t *lenp, loff_t *ppos );
#else
