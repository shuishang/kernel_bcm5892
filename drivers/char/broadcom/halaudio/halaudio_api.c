...
#define HALAUDIO_NANE               "halaudio"

/* Procfs file name */
#define HALAUDIO_PROC_NAME          HALAUDIO_NANE
...
{
#ifdef CONFIG_BCM_BSC
#define MAX_NAMES_BUFFER_LEN 100
   int                i;
   ...
   err = register_chrdev( BCM_HALAUDIO_MAJOR, HALAUDIO_NANE, &gfops );
   if ( err )
   {
...
#if CONFIG_SYSFS
   halaudio_class = class_create(THIS_MODULE,"bcmring-halaudio");
...
err_unregister_chrdev:
   unregister_chrdev(BCM_HALAUDIO_MAJOR, HALAUDIO_NANE);
#endif
