...
*
* 
* Unless otherwise stated by the stipulations of the disclaimer below, You may
* use this file under the terms of either the Apache License, Version 2.0 or
* the GNU General Public License (GPL) Version 2 as published by the Free
* Software Foundation.

* You may obtain a copy of the applicable license at
...
* damage if the system or device malfunctions. In addition, the Work is not fit
* for use in products which interact with motor vehicle systems.
...
#include <linux/broadcom/bma150_driver.h>
#include "smb380.h"
...
static const unsigned short bma150_normal_i2c[] = 
{
     0x38, I2C_CLIENT_END
};

static unsigned short bma150_ignore[2] = {I2C_CLIENT_END, I2C_CLIENT_END};
static struct i2c_client_address_data bma150_addr_data = 
{
	bma150_normal_i2c,
	bma150_ignore,
	bma150_ignore,
...
static int bma150_suspend_driver(struct i2c_client *p_client, pm_message_t mesg)
{
   int err;
#ifdef BMA150_DEBUG
   printk("bma150_suspend_driver\n"); 
#endif
   err = smb380_set_mode(SMB380_MODE_SLEEP);   
   
   return err;
}

static int bma150_resume_driver(struct i2c_client *p_client)
{
   int err;
#ifdef BMA150_DEBUG
   printk("bma150_resume_driver\n"); 
#endif
			  ...
			  struct i2c_board_info *info)
{
    ...
    strlcpy(info->type, BMA150_DRIVER_NAME, I2C_NAME_SIZE);
			 ...
			 const struct i2c_device_id *id)
{
	...
	printk("bma150: slave address 0x%x\n", client->addr);
   ...
   printk(KERN_INFO "bma150 device create ok\n");
    ...
    // if rebooted in sleep mode, may need to set this to NORMAL explicitly
...
static struct i2c_device_id bma150_id[] = {
   { BMA150_DRIVER_NAME, 0 },
   { }
};
...
static struct i2c_driver bma150_driver = {	
    ...
    .suspend      = bma150_suspend_driver,
    .resume       = bma150_resume_driver,
};
