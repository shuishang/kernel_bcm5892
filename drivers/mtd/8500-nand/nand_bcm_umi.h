...
#define NAND_ECC_BCH 1
#else
#define NAND_ECC_BCH 0
#endif
#define NAND_ECC_BCH_NUM_BYTES CFG_GLOBAL_NAND_ECC_BCH_NUM_BYTES
...
#define NAND_ECC_BCH 0
#endif
#define NAND_ECC_BCH_NUM_BYTES CONFIG_MTD_NAND_BCM_UMI_ECC_NUM_BYTES
#endif
...
#else
#define NAND_ECC_NUM_BYTES NAND_ECC_BCH_NUM_BYTES
#endif
#else
...
/* 
 * Turn this flag on to see ECC correction details with knllog.
 * This will affect bcm_umi_bch.c and nand_bcm_umi.c
 */
#define NAND_BCM_UMI_KNLLOG   0

#if NAND_BCM_UMI_KNLLOG
   #ifdef __KERNEL__
      #include <linux/broadcom/knllog.h>
   #else
      #define KNLLOG(fmt, args...)
   #endif
#else
   #define KNLLOG(fmt, args...)
#endif
...
/* 
 * Enable this extern if the kernel has been patched in 
 * nand_base.c to export the gPage in nand_do_read_ops()
 * This gives us the page address of interest. 
 */
#define NAND_BCM_UMI_EXTERN_GPAGE 0 
...
#endif
{
	...
	if (pageSize == NAND_DATA_ACCESS_SIZE) {
		while (numToRead > (numEccBytes+1)) {  /* ECC+BI */
