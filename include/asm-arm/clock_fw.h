...
/* Default values that can be used by cpufreq. */
#define DEFAULT_POLICY_MIN_FREQ_IN_KHZ 1000 
#define DEFAULT_POLICY_MAX_FREQ_IN_KHZ 312000
#define DEFAULT_CPU_MIN_FREQ_IN_KHZ 1000
#define DEFAULT_CPU_MAX_FREQ_IN_KHZ 312000
