...
#ifndef BCM5892_CODEC_H
#define BCM5892_CODEC_H

typedef enum ExternalCodecName_t
{
        Unknown=0,
        Wolfson_WM8750BL=1,
        RealTek_ALC5623=2
 ...
 *  Register
 **********************************************************************/
#define CODECREG_LEFT_INPUT_VOLUME	    0x00 /* R0 */
#define CODECREG_RIGHT_INPUT_VOLUME	    0x01 /* R1 */
#define CODECREG_LOUT1_VOLUME	        0x02 /* R2 */
#define CODECREG_ROUT1_VOLUME	        0x03 /* R3 */

#define CODECREG_ADC_DAC_CONTROL  	    0x05 /* R5 */
#define CODECREG_REST_INPUT_VOLUME	    0x06 /* R6 */
#define CODECREG_AUDIO_INTERFACE  	    0x07 /* R7 */
#define CODECREG_SAMPLE_RATE      	    0x08 /* R8 */

#define CODECREG_LEFT_DAC_VOLUME  	    0x0A /* R10 */
#define CODECREG_RIGHT_DAC_VOLUME 	    0x0B /* R11 */
#define CODECREG_BASS_CONTROL     	    0x0C /* R12 */
#define CODECREG_TREBLE_CONTROL   	    0x0D /* R13 */

#define CODECREG_RESET            	    0x0F /* R15 */
#define CODECREG_3D_CONTROL       	    0x10 /* R16 */
#define CODECREG_ALC1             	    0x11 /* R17 */
#define CODECREG_ALC2             	    0x12 /* R18 */
#define CODECREG_ALC3             	    0x13 /* R19 */
#define CODECREG_NOISE_GATE       	    0x14 /* R20 */
#define CODECREG_LEFT_ADC_VOLUME  	    0x15 /* R21 */
#define CODECREG_RIGHT_ADC_VOLUME 	    0x16 /* R22 */
#define CODECREG_ADDITIONAL_CONTROL1    0x17 /* R23 */
#define CODECREG_ADDITIONAL_CONTROL2    0x18 /* R24 */
#define CODECREG_PWR_MGMT1        	    0x19 /* R25 */
#define CODECREG_PWR_MGMT2        	    0x1A /* R26 */
#define CODECREG_ADDITIONAL_CONTROL3    0x1B /* R27 */

#define CODECREG_ADC_INPUT_MODE   	    0x1F /* R31 */
#define CODECREG_ADCL_SIGNAL_PATH 	    0x20 /* R32 */
#define CODECREG_ADCR_SIGNAL_PATH 	    0x21 /* R33 */
#define CODECREG_LEFT_OUT_MIX1    	    0x22 /* R34 */
#define CODECREG_LEFT_OUT_MIX2    	    0x23 /* R35 */
#define CODECREG_RIGHT_OUT_MIX1   	    0x24 /* R36 */
#define CODECREG_RIGHT_OUT_MIX2   	    0x25 /* R37 */
#define CODECREG_MONO_OUT_MIX1    	    0x26 /* R38 */
#define CODECREG_MONO_OUT_MIX2    	    0x27 /* R39 */
#define CODECREG_LOUT2_VOLUME     	    0x28 /* R40 */
#define CODECREG_ROUT2_VOLUME     	    0x29 /* R41 */
#define CODECREG_MONOOUT_VOLUME         0x2A /* R42 */


/**********************************************************************
 *  Register Fields
 **********************************************************************/
#define CODECFIELD_LROUT1_VOLUME_MAX    0x007F  /*R2/R3, 0b111,1111 */
#define CODECFIELD_LROUT1_VOLUME_MIN    0x002F  /*       0b010,1111 */
#define CODECFIELD_LROUT1_VOLUME_UPDATE 0x0100  /*       [8] */

#define CODECFIELD_FORMAT_I2S           0x0002  /*R7  [1:0] */
#define CODECFIELD_WORD_LENGTH_16       0x0000  /*    [3:2] */
#define CODECFIELD_WORD_LENGTH_20       0x0004  /*          */
#define CODECFIELD_WORD_LENGTH_24       0x0008  /*          */
#define CODECFIELD_WORD_LENGTH_32       0x000C  /*          */

#define CODECFIELD_USB                  0x0001  /*R8  [0]   */

#define CODECFIELD_LD2LO                0x0100  /*R34 [8]    ENABLE "LEFT DAC TO LEFT MIXER" */

#define CODECFIELD_RD2RO                0x0100  /*R37 [8]    ENABLE "R    DAC TO R    MIXER" */

#define CODECFIELD_VMIDSEL_OFF          0x0000  /*R25 [8:7] */
#define CODECFIELD_VMIDSEL_PLAYBACK     0x0080  /*           50K   */
#define CODECFIELD_VMIDSEL_LOWPOWER     0x0100  /*           500K  */
#define CODECFIELD_VMIDSEL_FASTSTARTUP  0x0180  /*           5K    */
#define CODECFIELD_VREF                 0x0040  /*R25 [6]   */

#define CODECFIELD_DACL                 0x0100  /*R26 [8]   */
#define CODECFIELD_DACR                 0x0080  /*    [7]   */
#define CODECFIELD_LOUT1                0x0040  /*    [6]   */
#define CODECFIELD_ROUT1                0x0020  /*    [5]   */





/* ALC5623 related stuff */
#define RT5623_RESET 0X00 //RESET CODEC TO DEFAULT
#define RT5623_SPK_OUT_VOL 0X02 //SPEAKER OUT VOLUME
#define RT5623_HP_OUT_VOL 0X04 //HEADPHONE OUTPUT VOLUME
#define RT5623_MONO_AUX_OUT_VOL 0X06 //MONO OUTPUT/AUXOUT VOLUME
#define RT5623_AUXIN_VOL 0X08 //AUXIN VOLUME
#define RT5623_LINE_IN_VOL 0X0A //LINE IN VOLUME
#define RT5623_STEREO_DAC_VOL 0X0C //STEREO DAC VOLUME
#define RT5623_MIC_VOL 0X0E //MICROPHONE VOLUME
#define RT5623_MIC_ROUTING_CTRL 0X10 //MIC ROUTING CONTROL
#define RT5623_ADC_REC_GAIN 0X12 //ADC RECORD GAIN
#define RT5623_ADC_REC_MIXER 0X14 //ADC RECORD MIXER CONTROL
#define RT5623_SOFT_VOL_CTRL_TIME 0X16 //SOFT VOLUME CONTROL TIME
#define RT5623_OUTPUT_MIXER_CTRL 0X1C //OUTPUT MIXER CONTROL
#define RT5623_MIC_CTRL 0X22 //MICROPHONE CONTROL
#define RT5623_AUDIO_INTERFACE 0X34 //AUDIO INTERFACE
#define RT5623_STEREO_AD_DA_CLK_CTRL 0X36 //STEREO AD/DA CLOCK CONTROL
#define RT5623_COMPANDING_CTRL 0X38 //COMPANDING CONTROL
#define RT5623_PWR_MANAG_ADD1 0X3A //POWER MANAGMENT ADDITION 1
#define RT5623_PWR_MANAG_ADD2 0X3C //POWER MANAGMENT ADDITION 2
#define RT5623_PWR_MANAG_ADD3 0X3E //POWER MANAGMENT ADDITION 3
#define RT5623_ADD_CTRL_REG 0X40 //ADDITIONAL CONTROL REGISTER
#define RT5623_GLOBAL_CLK_CTRL_REG 0X42 //GLOBAL CLOCK CONTROL REGISTER
#define RT5623_PLL_CTRL 0X44 //PLL CONTROL
#define RT5623_GPIO_OUTPUT_PIN_CTRL 0X4A //GPIO OUTPUT PIN CONTROL
#define RT5623_GPIO_PIN_CONFIG 0X4C //GPIO PIN CONFIGURATION
#define RT5623_GPIO_PIN_POLARITY 0X4E //GPIO PIN POLARITY/TYPE
#define RT5623_GPIO_PIN_STICKY 0X50 //GPIO PIN STICKY
#define RT5623_GPIO_PIN_WAKEUP 0X52 //GPIO PIN WAKE UP
#define RT5623_GPIO_PIN_STATUS 0X54 //GPIO PIN STATUS
#define RT5623_GPIO_PIN_SHARING 0X56 //GPIO PIN SHARING
#define RT5623_OVER_TEMP_CURR_STATUS 0X58 //OVER TEMPERATURE AND CURRENT STATUS
#define RT5623_JACK_DET_CTRL 0X5A //JACK DETECT CONTROL REGISTER
#define RT5623_MISC_CTRL 0X5E //MISC CONTROL
#define RT5623_PSEDUEO_SPATIAL_CTRL 0X60 //PSEDUEO STEREO & SPATIAL EFFECT BLOCK CONTROL
#define RT5623_EQ_CTRL 0X62 //EQ CONTROL
#define RT5623_EQ_MODE_ENABLE 0X66 //EQ MODE CHANGE ENABLE
#define RT5623_AVC_CTRL 0X68 //AVC CONTROL
#define RT5623_HID_CTRL_INDEX 0X6A //HIDDEN CONTROL INDEX PORT
#define RT5623_HID_CTRL_DATA 0X6C //HIDDEN CONTROL DATA PORT
#define RT5623_VENDOR_ID1       0x7C //VENDOR ID1
#define RT5623_VENDOR_ID2       0x7E //VENDOR ID2
...
#define ALC5623_LR_HP_VOLUME_MAX    0x0000  
#define ALC5623_LR_HP_VOLUME_MIN    0x001F  
...
//int bcm5892_codec_power_off(void);
