...
unsigned int bcm5892_i2s_init(void);
void         bcm5892_i2s_softreset(void);
unsigned int bcm5892_i2s_tx_config(bool bMono, unsigned int nSamplingRate);
unsigned int bcm5892_i2s_tx_enable(void);
unsigned int bcm5892_i2s_tx_disable(void);
unsigned int bcm5892_i2s_tx_flush(void);
void         bcm5892_i2s_tx_buffer(int16_t *pVirData, uint16_t *pPhyData, unsigned int nLen);
unsigned int bcm5892_i2s_exit(void);
unsigned int bcm5892_i2s_tx_int_happened(void);
void         bcm5892_i2s_tx_int_clear(void);
void         bcm5892_i2s_tx_irq(void);
unsigned int bcm5892_i2s_tx_buffer_empty(void);
 ...
 *  Register
 **********************************************************************/
#define I2SREG_DATXCTRL	    (volatile unsigned int *)(gI2Sctx.i2s_reg_base + 0x0000) /* 0xd00d8000 */
#define I2SREG_DARXCTRL	    (volatile unsigned int *)(gI2Sctx.i2s_reg_base + 0x0004)
#define I2SREG_DAFIFO_DATA  (volatile unsigned int *)(gI2Sctx.i2s_reg_base + 0x0008)
#define I2SREG_DAI2S   	    (volatile unsigned int *)(gI2Sctx.i2s_reg_base + 0x000C) /* CONTROL REG */
#define I2SREG_DAI2SRX      (volatile unsigned int *)(gI2Sctx.i2s_reg_base + 0x0010)
#define I2SREG_DADMACTRL    (volatile unsigned int *)(gI2Sctx.i2s_reg_base + 0x0014)
#define I2SREG_DADEBUG 	    (volatile unsigned int *)(gI2Sctx.i2s_reg_base + 0x0018)
#define I2SREG_DASTA   	    (volatile unsigned int *)(gI2Sctx.i2s_reg_base + 0x001C)
#define I2SREG_DADEBUG_TXP  (volatile unsigned int *)(gI2Sctx.i2s_reg_base + 0x0020)
#define I2SREG_DADEBUG_RXP  (volatile unsigned int *)(gI2Sctx.i2s_reg_base + 0x0024)
